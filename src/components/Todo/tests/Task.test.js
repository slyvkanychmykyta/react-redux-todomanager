...
describe('Компонент Todo:', () => {
    ...
    describe('должен иметь базовые пропсы, полученные от родительского компонента TodoManager:', () => {
        ...
        describe('_removeTaskAsync — асинхронный метод компонента TodoManager, запускающий API-запрос по удалению задачи по ID', () => {
            test('должен существовать', () => {
        ...
        describe('_updateTaskAsync — асинхронный метод компонента TodoManager, запускающий API-запрос по обновлению задачи', () => {
            test('должен существовать', () => {
